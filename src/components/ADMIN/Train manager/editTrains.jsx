  ...
  const fetchTrain = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://localhost:5000/api/seller/singletrain?_id=${_id}`
      );
      ...
      if (response.data.success) {
        ...
        setFormData({
          ...
          fromStation: {
            stationName:
              data.fromStation?.stationName || "",
            city:
              data.fromStation?.city || "",
            stationCode:
              data.fromStation?.stationCode || ""
          },
          ...
          journeyStartDate:
            data.journeyStartDate
              ? data.journeyStartDate.split("T")[0]
              : "",

          journeyEndDate:
            data.journeyEndDate
              ? data.journeyEndDate.split("T")[0]
              : "",
          ...
          pantryAvailable:
            data.pantryAvailable || false,

          tatkalAvailable:
            data.tatkalAvailable || false,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:5000/api/seller/updateTrain/${_id}`,
        payload
      );
